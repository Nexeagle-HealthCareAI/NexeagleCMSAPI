...
public class HospitalServiceTests
{
    ...
    public async Task GetHospitalsAsync_CallsRepository()
    {
        ...
        _mockRepo.Setup(r => r.GetHospitalsAsync(1, 10, null, null, null, null, null, false)).ReturnsAsync(paged);
        ...
        _mockRepo.Verify(r => r.GetHospitalsAsync(1, 10, null, null, null, null, null, false), Times.Once);
    }
